function model_stage = TY_do_hard_negtive_train(conf, dataset, model_stage, do_val, hditer)
    if ~do_val
        dataset.imdb_test = struct();
        dataset.roidb_test = struct();
    end

    model_stage.output_model_file = TY_hard_negtive_train(conf, dataset.imdb_train, dataset.roidb_train, ...
                                    'do_val',           do_val, ...
