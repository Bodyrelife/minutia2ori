function model = TY_VGG16_for_Faster_RCNN(model)
...
model.stage1_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'vgg_16layers_conv3_1', 'solver_30k40k_lw5.prototxt');
...
model.stage2_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'vgg_16layers_fc6', 'solver_30k40k_lw5.prototxt');
...
model.final_test.nms.after_nms_topN          	= 400;
end