function TY_train_faster_rcnn_o()
...
conf_fast_rcnn.bbox_thresh = 15;
conf_fast_rcnn.fg_thresh = 15; 
...
% test
dataset.imdb_train        	= cellfun(@(x, y) Faster_RCNN_Train.TY_do_proposal_test(conf_proposal, model.stage1_rpn, x, y), dataset.imdb_train, dataset.roidb_train, 'UniformOutput', false);
dataset.imdb_test        	= cellfun(@(x, y) Faster_RCNN_Train.TY_do_proposal_test(conf_proposal, model.stage1_rpn, x, y), dataset.imdb_test, dataset.roidb_test, 'UniformOutput', false);
...
% test
opts.mAP                    = Faster_RCNN_Train.TY_do_fast_rcnn_test(conf_fast_rcnn, model.stage1_fast_rcnn, dataset.imdb_test, dataset.roidb_test);
...
% test
dataset.imdb_train       	= cellfun(@(x, y) Faster_RCNN_Train.TY_do_proposal_test(conf_proposal, model.stage2_rpn, x, y), dataset.imdb_train, dataset.roidb_train, 'UniformOutput', false);
dataset.imdb_test       	= cellfun(@(x, y) Faster_RCNN_Train.TY_do_proposal_test(conf_proposal, model.stage2_rpn, x, y), dataset.imdb_test, dataset.roidb_test, 'UniformOutput', false);

%%  stage two fast rcnn
fprintf('\n***************\nstage two fast rcnn\n***************\n');
% train
% model.stage2_fast_rcnn.init_net_file = model.stage1_rpn.output_model_file;
...
dataset.imdb_test       	= cellfun(@(x, y) Faster_RCNN_Train.TY_do_proposal_test(conf_proposal, model.stage2_rpn, x, y), dataset.imdb_test, dataset.roidb_test, 'UniformOutput', false);
opts.final_mAP              = Faster_RCNN_Train.TY_do_fast_rcnn_test(conf_fast_rcnn, model.stage2_fast_rcnn, dataset.imdb_test, dataset.roidb_test);
